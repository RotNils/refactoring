...
public class TreeTest {
    ...
    public void testTreeCreation() {
        ...
        Assertions.assertEquals("41.177772696363114", tree.location.getLocationLatitude());
        Assertions.assertEquals("-8.59843522310257", tree.location.getLocationLongitude());
        Assertions.assertEquals("FEUP", tree.location.getLocationName());
    }
    ...
    public void testTreeSetLocation() {
        ...
        Assertions.assertEquals(tree.plantedAt, date);
        Assertions.assertEquals("loclat", tree.location.getLocationLatitude());
        Assertions.assertEquals("loclon", tree.location.getLocationLongitude());
        Assertions.assertEquals("locname", tree.location.getLocationName());
    }
