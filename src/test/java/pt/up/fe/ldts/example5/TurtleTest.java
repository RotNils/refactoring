...
public class TurtleTest {
    ...
    public void testRotateLeft() {
        ...
        turtle.execute('L'); assertEquals('W', turtle.getDirection().toChar());
        turtle.execute('L'); assertEquals('S', turtle.getDirection().toChar());
        turtle.execute('L'); assertEquals('E', turtle.getDirection().toChar());
        turtle.execute('L'); assertEquals('N', turtle.getDirection().toChar());
    ...
    public void testRotateRight() {
        Turtle turtle = new Turtle(5, 5, new TurtleNorth());
        turtle.execute('R'); assertEquals('E', turtle.getDirection().toChar());
        turtle.execute('R'); assertEquals('S', turtle.getDirection().toChar());
        turtle.execute('R'); assertEquals('W', turtle.getDirection().toChar());
        turtle.execute('R'); assertEquals('N', turtle.getDirection().toChar());
        assertEquals(5, turtle.getRow());
        assertEquals(5, turtle.getColumn());
    }
